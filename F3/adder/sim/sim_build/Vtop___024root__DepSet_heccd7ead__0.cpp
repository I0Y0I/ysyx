...
#endif
            VL_FATAL_MT("../m1s_complement_adder.sv", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../m1s_complement_adder.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../m1s_complement_adder.sv", 1, "", "Active region did not converge.");
            }
